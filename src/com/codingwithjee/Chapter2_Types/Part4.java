...
//        Short.parseShort() >> takes string and return short 기타 등등...
        ...
        System.out.println(result123123);
        int result12341234 = (int)Math.ceil(1.2F); // ceil/ceiling returns the larger integer that is >= or = to the number
        System.out.println(result12341234);
        int result123123123 = (int)Math.floor((1.2F));
        System.out.println(result123123123);// floor returns the integer to the smaller integer
        int result1010101 = Math.max(2,23);
        System.out.println(result1010101);
        int result01010 = Math.min(303,32);
        System.out.println(result01010);
        double result9898 = Math.random() * 100; // multiply by 100 to get a random number between 0~100
        System.out.println(result9898); // prints a random number between 0~1... if want a number between 0~100
